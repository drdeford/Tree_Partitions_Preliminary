...
from tree_proposal_spaced_AR import propose_bounce_single_cut, propose_merge2_tree
...
proposal_method = propose_bounce_single_cut#propose_merge2_tree# propose_random_flip# propose_random_flip#propose_tree#mixed_proposal#propose_grid_swap#S
...
newdir = "./Outputs/Grid_Anim/" + state_name + "run" + str(current)[:10] + "-" + str(current)[11:13]\
...
district_col="3CD"#"rowCD"#"D_CD"#"Dperp_CD"#
...
#table[num_steps]["All Flips:"][-1]=dict()
...
for num_steps in range(1, steps):
    ...
    if table[num_steps]["All Flips:"] is not None:
