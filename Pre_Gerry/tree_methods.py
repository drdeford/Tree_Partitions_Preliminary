...
''' This function constructs a new partition by recursively
 generating a spanning tree for the remaining graph and splitting 
 off a district with population within epsilon of ideal.
 '''
    newlabels={}
    pop_target=0
